    ...
    match outline {
        BaselineOutline::Swept {
            ...
            space: match frame.space {
                ...
                Space::Lambert => StampSpace::Lambert,
                Space::Behrmann => StampSpace::Behrmann,
                Space::GallPeters => StampSpace::GallPeters,
                Space::HoboDyer => StampSpace::HoboDyer,
                Space::GallStereographic => StampSpace::GallStereographic,
                Space::Braun => StampSpace::Braun,
                Space::CentralCylindrical => StampSpace::CentralCylindrical,
                Space::Patterson => StampSpace::Patterson,
