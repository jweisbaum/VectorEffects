...
impl Default for Palette {
    ...
    /// slate, and these sit within a few steps of it.
    ///
    /// **`land` is the default basemap's own land, to the byte** (Sage in
    /// `settings/themes.json`, `#3b6064`). A chart covers the stretch of
    ...
    fn default() -> Self {
        Self {
            shallow: [85, 130, 139, 255],
            middle: [65, 101, 115, 255],
            deep: [54, 73, 88, 255],
            land: [59, 96, 100, 255],
            coast: [135, 187, 162, 255],
            contour: [135, 187, 162, 180],
            aid: [190, 170, 90, 230],
            hazard: [200, 110, 100, 235],
            text: [201, 228, 202, 220],
            caution: [150, 130, 175, 190],
            built: [105, 148, 143, 255],
        }
    }
}
...
mod tests {
    ...
    /// The default Sage land in `ui/src/settings/themes.json`, rounded to bytes.
    #[test]
    fn chart_land_is_the_basemaps_own_land() {
        let basemap = [59.0_f32 / 255.0, 96.0 / 255.0, 100.0 / 255.0];
